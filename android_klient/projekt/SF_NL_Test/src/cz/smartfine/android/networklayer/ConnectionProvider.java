...
public class ConnectionProvider {
	 ...
	 * 
	 * @return true, pokud se podařilo připojit a zároveň přihlásit, false pokud
	 *         se nepodařilo připojit, nebo se nepodařilo přihlásit nebo nejsou
	 *         k dispozici přihlašovací údaje.
	 */
		...
		if (LoginProvider.isAvaibleLoginInformation(this.appContext)) {
			...
			ILoginProviderListener lpl = new ILoginProviderListener() {
				...
				public void onLoginFailed(LoginFailReason reason) {
					System.out.println("ANDROID: CP CAN LOGIN LISTENER FAILED");
					try {
