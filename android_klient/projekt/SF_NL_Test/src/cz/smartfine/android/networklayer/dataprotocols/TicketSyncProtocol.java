 ...
 *
 * @author Pavel Brož
 * @version 1.0 @created 14-4-2012 18:48:49
 */
public class TicketSyncProtocol implements IDataProtocol {
     ...
     * @param badgeNumber Služební číslo policisty, který PL odesílá. Pozn.: nemusí se shodovat s číslem policisty, který je přihlášen.
