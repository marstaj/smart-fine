...
public class Conventer {
	...
	/**
	 * Převede pole bytů na int. Metoda začíná v poli na indexu určeným
	 * parametrem offset.
	 * 
	 * @return Číslo int.
	 * 
	 * @param b
	 *            Pole bytů o minimální délce 4 + offset.
	 * @param offset
	 *            Začátek čísla int.
	 */
	public static int byteArrayToInt(byte[] b, int offset) {
		return ((b[offset] << 24) + ((b[1 + offset] & 0xFF) << 16)
	...
	/**
	 * Převede pole bytů na long. Metoda začíná v poli na indexu určeným
	 * parametrem offset.
	 * 
	 * @return Číslo long.
	 * 
	 * @param b
	 *            Pole bytů o minimální délce 8 + offset.
	 * @param offset
	 *            Začátek čísla long.
	 */
	public static long byteArrayToLong(byte[] b, int offset) {
		return (((long) b[offset] << 56)
				...
				+ ((long) (b[6 + offset] & 0xFF) << 8) + ((long) (b[7 + offset] & 0xFF)));
	}
}
