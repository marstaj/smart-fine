...
public class SPCCheckProtocol implements IDataProtocol {
    ...
    public void onReceivedData(byte[] receivedData) {
        ...
        if (spcCheckProtocolListener != null) {
            ...
            switch (receivedData[0]) {
                case MobileMessageIDs.ID_MSG_STATUS_SPC: //stav PPK//
                    ...
                    int spcNumLength = Conventer.byteArrayToInt(receivedData, 2); // zjištění délky pole s číslem PPK
                    spcNumber = new String(receivedData, 6, spcNumLength); // převedení pole bytů na string
    ...
    /**
     * Zjistí stav přenosné parkovací karty tj. jestli je hášena jako odcizená či nikoliv.
     *
    ...
    protected byte[] createSPCMessage(String spcNumber) {
        ...
        msg.putArrayWithIntLength(spcNumber.getBytes()); // vloží délku pole a pole se znaky čísla PPK
