...
/**
 * Třída představující objekt, který pracuje s fotografiemi v parkovacích
 * lístcích.
 * 
...
public class PhotoDAO implements IPhotoDAO {
	...
	/**
	 * Cesta na paměťovou kartu
	 */
	private File card;

	/**
	 * Cesta do složky pro fotografie
	 */
	 ...
	 *            Kontext aplikace
	 * @throws Exception
	 *             Výjimka vznikde když nelze vytvořit složku pro ukládání
	 *             fotografí.
	 */
	 ...
	 * 
	 * @see
	 * cz.smartfine.android.dao.IPhotoDAO#deleteAllPhotos(java.util.ArrayList)
	 */
	public void deleteAllPhotosFromTickets(ArrayList<Ticket> tickets) {
		...
		for (int i = 0; i < tickets.size(); i++) {
			deleteAllPhotosFromTicket(tickets.get(i));
		}
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cz.smartfine.android.dao.interfaces.IPhotoDAO#fileDestination()
	 */
	 ...
	 * 
	 * @see
	 * cz.smartfine.android.dao.interfaces.IPhotoDAO#deleteAllPhotosFromTicket
	 * (cz.smartfine.android.model.Ticket)
	 */
	public void deleteAllPhotosFromTicket(Ticket ticket) {
		if (ticket.getPhotos() != null) {
			for (int j = 0; j < ticket.getPhotos().size(); j++) {
				// Pouze pokud je ve slozce smartfine - jenom fotky vyfocene zkrze smartfine
				File f = ticket.getPhotos().get(j);
