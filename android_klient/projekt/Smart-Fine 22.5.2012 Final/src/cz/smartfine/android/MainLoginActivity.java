...
public class MainLoginActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Toaster.toast(R.string.inicialization_error, Toaster.LONG);
			return;
		}
	...
	public void syncAddressClick(View button) {
		...
		if (prefManager.setSyncUrl(this, address)) {
			...
			Toaster.toast(R.string.val_syncadress_success, Toaster.SHORT);
		} else {
			Toaster.toast(R.string.val_pref_syncserver_err, Toaster.SHORT);
		}
	}
