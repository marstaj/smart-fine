package cz.smartfine.pc.networklayer.links;
 ...
 */
public class SecuredPCClientLink extends SecuredClientLink {
     ...
     */
    public SecuredPCClientLink(InetSocketAddress address, InputStream keyStoreStream, String keyStorePassword) throws KeyStoreException, CertificateException, IOException, KeyManagementException {
        super("TLSv1", "jks", address, keyStoreStream, keyStorePassword);
    }
}
