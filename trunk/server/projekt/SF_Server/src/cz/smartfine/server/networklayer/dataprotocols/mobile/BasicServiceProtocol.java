...
public class BasicServiceProtocol implements IDataProtocol {
    ...
    /**
     * Příznak, klient není přihlášen a že se přijímají všechny typy zpráv.
     * Před přihlášením je nutné v případě obdržení jiné zprávy než přihlašovací, ukončit spojení -> je nutné kontrolovat všechny zprávy. (true)
     * Po přihlášení již není nutné příjímat všechny typy zpráv. (false)
     */
