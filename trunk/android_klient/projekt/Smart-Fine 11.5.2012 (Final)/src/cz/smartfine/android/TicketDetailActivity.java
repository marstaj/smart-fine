...
public class TicketDetailActivity extends Activity {
	...
	public void printTicketClick(final View button) {
		...
		//TODO do R.
		builder.setMessage("Opravdu chcete vytisknout tento parkovací lístek?");
	...
	private void checkBluetoothEnabled() {
		...
		if (Phone.isBluetoothEnabled()) {
			...
			builder.setMessage("Pro připojení k tiskárně musíte zapnout Bluetooth. Chcete zapnout Bluetooth nyní?");
			builder.setCancelable(false);
	...
	public void removeTicketClick(View button) {
		...
		Builder builder = new Builder(this);
		//TODO do R.
		builder.setMessage("Opravdu chcete smazat tento parkovací lístek?");
		builder.setCancelable(false);
		//TODO do R.
		builder.setPositiveButton("Ano", new OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				try {
					...
					// TODO do R
					Toaster.toast("Parkovací lístek se napodařilo smazat.", Toaster.SHORT);
				}
	...
	public void onSuccessPrint() {
		...
		// TODO to R
		Toaster.toast("Lístek byl úspěšně vytisknut.", Toaster.SHORT);
