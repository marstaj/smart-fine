...
/**
 * Tøída pro práci s DAO pro laws
 * 
...
public class FileLawDAO implements IFreqValuesDAO {
	...
	private ArrayList<Law> loadLawsFromHere() {
		...
		if (laws == null) {
			...
			laws.add(b);
			Law c = new Law();
			c.setEventDescription("Podélné parkování v protismìru");
			c.setRuleOfLaw(3);
			c.setParagraph(3);
			c.setLetter("c");
			c.setLawNumber(3);
			...
			laws.add(c);
			Law d = new Law();
			d.setEventDescription("Parkování na nezpevnìném povrchu");
			d.setRuleOfLaw(4);
			d.setParagraph(4);
			d.setLetter("d");
			d.setLawNumber(4);
			...
			laws.add(d);
			Law e = new Law();
			e.setEventDescription("Parkování na pøechodu pro chodce");
			e.setRuleOfLaw(4);
			e.setParagraph(4);
			e.setLetter("d");
			e.setLawNumber(4);
			...
			laws.add(e);
			Law f = new Law();
			f.setEventDescription("Parkování na vyhrazeném místì");
			f.setRuleOfLaw(4);
			f.setParagraph(4);
			f.setLetter("d");
			f.setLawNumber(4);
			...
			laws.add(g);
			Law h = new Law();
			h.setEventDescription("Parkování mimo vyznaèený smìr");
			h.setRuleOfLaw(4);
			h.setParagraph(4);
			h.setLetter("d");
			h.setLawNumber(4);
			...
			laws.add(i);
			Law j = new Law();
			j.setEventDescription("Nedodržení minimální šíøky jízdního pruhu");
			j.setRuleOfLaw(4);
			j.setParagraph(4);
			j.setLetter("d");
			j.setLawNumber(4);
			...
			laws.add(j);
			Law k = new Law();
			k.setEventDescription("Parkování na chodníku (mimo vyznaèené parkovištì)");
			k.setRuleOfLaw(4);
			k.setParagraph(4);
			k.setLetter("d");
			k.setLawNumber(4);
