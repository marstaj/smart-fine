...
public class TicketEditActivity extends Activity {
	...
	/**
	 * Glob�ln� hodnota reprezentuj�c� vybrani fotografie z karty
	 */
	...
	/**
	 * Obsluha tla��tka - P�idat fotodokumentaci *
	 * 
	 * @param button
	 */
	...
	public void gpsClick(View button) {
		...
		if (Internet.isOnline(getApplicationContext())) {
			...
			Toaster.toast("Pro automatick� ur�en� adresy je pot�eba internetov� p�ipojen�.", Toaster.LONG);
		}
	}
	...
	private LocationResult locationResult = new LocationResult() {
		...
		public void gotLocationAddress(Address address) {
			if (address != null) {
				...
				// TODO napsat do R.String
				Toaster.toast("Nepoda�ilo se z�skat polohu.", Toaster.LONG);
			}
		}
	};
	...
	/**
	 * Nastav� hodnoty do spinneru a posluchace
	 */
	...
	/**
	 * Vytvo�en� nov�ho PL a p�i�azen� jeho atribut� NEBO zm�na �daj� PL, kter�
	 * editujeme
	 * 
	 * @return PL
	 */
	...
	/**
	 * Nastav� fotodokumentaci - zobraz� n�hledy fotografi� a p�i�ad� jim
	 * poslucha�e na zobrazen� v�t��ho n�hledu Nastav� p�id�v�n� nov�ch
	 * fotografi�
	 */
