...
public class FrequentValuesListAdapter extends ArrayAdapter<FrequentValue> implements Filterable {
	...
	// TODO DOdelat Komentare a javadoc
	...
	public Filter getFilter() {
		if (filter == null) {
			filter = new Filter() {
				...
				@Override
				protected void publishResults(CharSequence constraint, FilterResults results) { items = (ArrayList<FrequentValue>) results.values;
					if (results.count > 0) {
